      ...
      <div className='pt-24 text-black pt-16 md:pt-10 bg-light-pink p-10 md:w-1/2'>
        <div class="bg-pink mt-6 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-16">
          <div class="p-6"> 
              <div class="flex flex-col items-center justify-center">
                  <div class="w-full flex flex-col justify-center lg:flex-row gap-24 items-center">
                      ...
                      <div className='text-center lg:text-left'>
                        <h1 className="text-center lg:text-left text-lg font-bold">About:</h1>
                        <h1 className='text-center lg:text-left uppercase text-4xl font-light'>Teeth</h1>
                      </div>
                      <motion.div
                      initial={{x:-30, opacity:0}}
                      whileInView={{
                      ...
                      <div className='-mt-10 lg:mt-0 mb-8 lg:mb-0 lg:-ml-10 flex gap-5 items-center justify-center'>
              ...
              <div class="justify-center lg:justify-end mt-2">
                  <div class="border-y border-slate-200 mb-1 w-full h-8"></div>
              </div>
